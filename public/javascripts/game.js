...
socket.on('guessMatch', function(guess, time, score, globalScore) {
    ...
    overlayContent.html('Guess Match found!<br><br>' + guess + '<br>Time: ' + time + '<br>Score: ' + score + '<br><br>Insgesamt: ' + globalScore + '<br><br>Nächste Runde startet in wenigen Sekunden...');
